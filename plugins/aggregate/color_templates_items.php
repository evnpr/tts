...
function item_edit() {
	...
	$header_label = "[edit Color Template: " . db_fetch_cell("select name from plugin_aggregate_color_templates where color_template_id=" . $_GET["color_template_id"]) . "]";

	html_start_box("<strong>Color Template Items</strong> $header_label", "98%", $colors["header"], "3", "center", "");
